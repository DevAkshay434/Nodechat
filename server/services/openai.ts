      ...
      messages: [
        {
          role: "system",
          content:
            "Analyze the following content and provide metadata in JSON format including approximate word count, SEO score (1-10), and key SEO keywords/phrases.",
        },
        {
          role: "user",
